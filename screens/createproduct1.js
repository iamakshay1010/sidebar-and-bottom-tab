...
const CreateProduct = ({ props, navigation }) => {
  ...
  const addProduct = () => {
    ...
    if (item !== null) {
      ...
      //{ name,brand,price,description,category,countInStock,richDescription,isFeatured}
      // {
      //   image: image,
      //   name: name,
      //   brand: brand,
    ...
    <SafeAreaView style={{ flex: 1, paddingHorizontal: 10 }}>
      <ScrollView style={styles.scrollView}>
        ...
        /> */}
          ...
          <Button title="Create Product" mode="contained" onPress={() => addProduct()} >Create Product</Button>
          {/* <Button
